...
lazy val test = project
  .dependsOn(compiler, interactive, replJline, scalap, partestExtras, partestJavaAgent, scaladoc)
...
lazy val root: Project = (project in file("."))
  ...
  .aggregate(library, reflect, compiler, interactive, repl, replJline,
...
lazy val distDependencies = Seq(replJline, compiler, library, reflect, scalap, scaladoc)
