...
"Thread-1" prio=5 tid=7f9637267800 nid=0x1194fe000 in Object.wait() [1194fb000]
  ...
  at scala.runtime.SystemPropertiesties$.addHelp(SystemProperties.scala:64)
  at scala.runtime.SystemPropertiesties$.bool(SystemProperties.scala:68)
  at scala.runtime.SystemPropertiesties$.noTraceSupression$lzycompute(SystemProperties.scala:80)
  - locked <7b8b0e228> (a scala.runtime.SystemProperties$ies$)
  at scala.runtime.SystemPropertiesties$.noTraceSupression(SystemProperties.scala:80)
  ...
  at scala.package$.<init>(hashing.scala:46)
  at scala.package$.<clinit>(hashing.scala)
